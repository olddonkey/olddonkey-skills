 ...
 *
 * An optional link (OFF by default) can sit to the right of the viewport,
 * sharing the same hover trigger — pass `githubUrl` to enable it.
 */
            ...
            >
              ...
              {isActive && (
                <div className="pb-pips">
                  {Array.from({ length: c.notes.length }, (_, s) => (
                    <span
                      key={s}
                      className={`pb-pip ${
