...
一篇 AI / 工具 / 产品**实测对比**类文章 → 7 章 36 步 slides 的真实案例。

> ## ⚠️ 这是结构示意 / 历史案例，不是抄袭模板
>
> 这个目录的角色是让 agent 看："**测评类 slides 章节怎么切、信息池怎么
...
> 3. 双源原则怎么落地（hero 来自 outline / 数据角标来自原始素材 material）
>
...
| 双源应用 | hero 标语来自 outline、画面密度（具体分数 / 投票数 / 时间戳）来自原始素材 | 测评类素材数据极多 —— 用 mono cue / 角标 / 数据浮层挂出来 |
