...
> 开工准备。本 anchor 给的是"列举型章节的结构骨架"（单网格 N 槽位 +
...
讲"三件事 / 四个原因 / N 个特性"时，**每项 1 step 逐个揭示**。
中段最常用的章节类型，**最容易翻车成 PPT** —— 这是为什么需要 anchor。
...
- **step 1** — masthead 引子"<N 件事>"
- **step 2** — 第 1 件：<标题> + <从原始素材抽来的细节>
- **step 3** — 第 2 件：<标题>
- ...
- **step N+1** — 第 N 件：<标题>
```
...
## CHAPTER-CRAFT.md 「逐步揭示」一节 的核心实现
